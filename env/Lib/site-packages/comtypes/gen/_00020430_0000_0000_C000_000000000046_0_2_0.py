...
IFontDisp = Font
__all__ = [ 'OLE_YPOS_HIMETRIC', 'FontEvents', 'OLE_OPTEXCLUSIVE',
           'OLE_COLOR', 'OLE_XSIZE_CONTAINER', 'OLE_XPOS_PIXELS',
           'Monochrome', 'FONTUNDERSCORE', 'VgaColor', 'Color',
           'StdPicture', 'OLE_YPOS_CONTAINER',
           'OLE_ENABLEDEFAULTBOOL', 'IFontDisp', 'IPicture',
           'OLE_CANCELBOOL', 'FONTSIZE', 'OLE_YSIZE_PIXELS',
           'Unchecked', 'Picture', 'FONTSTRIKETHROUGH',
           'OLE_XPOS_CONTAINER', 'OLE_YPOS_PIXELS',
           'OLE_XSIZE_PIXELS', 'IFont', 'IFontEventsDisp', 'Font',
           'IPictureDisp', 'OLE_XPOS_HIMETRIC', 'StdFont', 'Default',
           'OLE_TRISTATE', 'LoadPictureConstants', 'FONTNAME',
           'OLE_YSIZE_HIMETRIC', 'FONTBOLD', 'FONTITALIC', 'Checked',
           'OLE_HANDLE', 'Gray', 'OLE_XSIZE_HIMETRIC',
           'OLE_YSIZE_CONTAINER']
